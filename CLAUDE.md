...
- **`data-nyc.json`, `data-brooklyn.json`, `data-queens.json`, `data-flushing.json`** — one dataset file per additional city, fetched lazily on first switch and cached in memory.
